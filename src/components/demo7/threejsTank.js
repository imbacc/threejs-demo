...
export default class threejsTank extends threejsWebGL {
    constructor() {
        super()
    ...
    initTank() {
        ...
        function resizeRendererToDisplaySize(domElement) {
        ...
        const tankRun = (time) => {
            ...
            if (resizeRendererToDisplaySize(this.webGLDOM)) {
                const canvas = this.webGLDOM
            ...
            this.webGL.render(scene, camera.cam)
        }

        // this.animationPlay('tankRun', tankRun.bind(this))
    }
